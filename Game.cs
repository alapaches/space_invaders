...
namespace SpaceInvaders
{
    class Game
    {
        ...
        private Game(Size gameSize)
        {
            ...
            // bunkers1 = new Bunker(new Vecteur2D((gameSize.Width / 5)-100, gameSize.Height - 150));
            // bunkers2 = new Bunker(new Vecteur2D(3*(gameSize.Width / 5)-125, gameSize.Height - 150));
            // bunkers3 = new Bunker(new Vecteur2D((gameSize.Width)-150, gameSize.Height - 150));
            // bunkers.Add(bunkers1);
            // bunkers.Add(bunkers2);
            // bunkers.Add(bunkers3);
